(defproject shanghai "0.1.0-SNAPSHOT"
  ...
  :source-paths ["assets/clojurescript/src"]
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                :compiler {:main shanghai.routes
                           :asset-path "public/js/compiled/out"
                           :output-to "public/js/compiled/shanghai.js"
               ...
               {:id "min"
                :source-paths ["assets/clojurescript/src"]
                :compiler {:output-to "public/js/compiled/shanghai.js"
                           :main shanghai.routes
